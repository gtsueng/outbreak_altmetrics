...
try:
    from outbreak_altmetrics.parser import load_annotations as parser_func
except ImportError:
    from .parser import load_annotations as parser_func


class AltmetricsUploader(biothings.hub.dataload.uploader.BaseSourceUploader):

    main_source = "outbreak_altmetrics"
    name = "outbreak_altmetrics"
    __metadata__ = {
        "src_meta": {
